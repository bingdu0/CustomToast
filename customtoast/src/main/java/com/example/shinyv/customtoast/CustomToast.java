package com.example.shinyv.customtoast;
...
public class CustomToast implements IToast {
    ...
    public void makeTextShow(Context context,String text, long duration) {
        new CustomToast(mContext)
                .setText(text)
                .setDuration(duration)
                .setGravity(Gravity.BOTTOM, 0, DisplayUtil.dip2px(context,64)).show();
    }
